...
if [ -z "${1}" ]; then
  ...
  echo "This is probably \`pwd\` if you're at the root of the quirkyturtcoin repository."
  exit 1
fi
...
echo
echo 'When compiling quirkyturtcoind, run `./configure` in the following way:'
echo
