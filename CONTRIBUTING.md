Contributing to quirkyturtcoin Core
============================

The quirkyturtcoin Core project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/quirkyturtcoin-project/quirkyturtcoin/blob/master/doc/translation_process.md)
...
The following applies to code changes to the quirkyturtcoin Core project, and is not to be
confused with overall quirkyturtcoin Network Protocol consensus changes.

Whether a pull request is merged into quirkyturtcoin Core rests with the project merge
...
Patches that change quirkyturtcoin consensus rules are considerably more involved than
...
Where a patchset proposes to change the quirkyturtcoin consensus, it must have been
...
The project leader is the release manager for each quirkyturtcoin Core release.
