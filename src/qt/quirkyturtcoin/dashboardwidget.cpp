...
#include "qt/quirkyturtcoin/forms/ui_dashboardwidget.h"
#include "qt/quirkyturtcoin/sendconfirmdialog.h"
#include "qt/quirkyturtcoin/txrow.h"
...
DashboardWidget::DashboardWidget(quirkyturtcoinGUI* parent) :
    PWidget(parent),
...
bool hasCharts = false;
    ...
    if (window)
        connect(window, &quirkyturtcoinGUI::windowResizeEvent, this, &DashboardWidget::windowResizeEvent);
#endif
