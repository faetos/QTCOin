...
#include "qt/quirkyturtcoin/sendcustomfeedialog.h"
#include "qt/quirkyturtcoin/forms/ui_sendcustomfeedialog.h"
...
SendCustomFeeDialog::SendCustomFeeDialog(quirkyturtcoinGUI* parent, WalletModel* model) :
    ...
    walletModel(model)
{
    ...
    if (parent)
        connect(parent, &quirkyturtcoinGUI::themeChanged, this, &SendCustomFeeDialog::onChangeTheme);
