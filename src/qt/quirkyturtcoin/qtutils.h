...
bool openDialogWithOpaqueBackgroundY(QDialog* widget, quirkyturtcoinGUI* gui, double posX = 3, int posY = 5);
bool openDialogWithOpaqueBackground(QDialog* widget, quirkyturtcoinGUI* gui, double posX = 3);
