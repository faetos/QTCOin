...
#include "qt/quirkyturtcoin/forms/ui_send.h"
#include "qt/quirkyturtcoin/addnewcontactdialog.h"
#include "qt/quirkyturtcoin/qtutils.h"
#include "qt/quirkyturtcoin/sendchangeaddressdialog.h"
#include "qt/quirkyturtcoin/optionbutton.h"
#include "qt/quirkyturtcoin/sendconfirmdialog.h"
#include "qt/quirkyturtcoin/guitransactionsutils.h"
#include "qt/quirkyturtcoin/loadingdialog.h"
...
SendWidget::SendWidget(quirkyturtcoinGUI* parent) :
    PWidget(parent),
    ui(new Ui::send),
    coinIcon(new QPushButton())
{
    ...
    ui->btnUri->setSubTitleClassAndText("text-subtitle", tr("Parse a quirkyturtcoin URI"));
