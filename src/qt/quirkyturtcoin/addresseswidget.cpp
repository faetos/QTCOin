...
#include "qt/quirkyturtcoin/forms/ui_addresseswidget.h"
#include "qt/quirkyturtcoin/addresslabelrow.h"
#include "qt/quirkyturtcoin/addnewaddressdialog.h"
...
AddressesWidget::AddressesWidget(quirkyturtcoinGUI* parent) :
    PWidget(parent),
