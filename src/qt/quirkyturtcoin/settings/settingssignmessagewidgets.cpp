...
#include "qt/quirkyturtcoin/settings/forms/ui_settingssignmessagewidgets.h"
...
SettingsSignMessageWidgets::SettingsSignMessageWidgets(quirkyturtcoinGUI* _window, QWidget *parent) :
