...
#include "qt/quirkyturtcoin/settings/forms/ui_settingswalletoptionswidget.h"
#include <QListView>
#include "optionsmodel.h"
#include "clientmodel.h"
#include "qt/quirkyturtcoin/qtutils.h"

SettingsWalletOptionsWidget::SettingsWalletOptionsWidget(quirkyturtcoinGUI* _window, QWidget *parent) :
