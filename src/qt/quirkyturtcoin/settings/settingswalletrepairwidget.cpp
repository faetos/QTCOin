...
#include "qt/quirkyturtcoin/settings/forms/ui_settingswalletrepairwidget.h"
#include "qt/quirkyturtcoin/qtutils.h"

SettingsWalletRepairWidget::SettingsWalletRepairWidget(quirkyturtcoinGUI* _window, QWidget *parent) :
...
void SettingsWalletRepairWidget::buildParameterlist(QString arg)
{
    ...
    // Send command-line arguments to quirkyturtcoinGUI::handleRestart()
