...
#include "qt/quirkyturtcoin/settings/forms/ui_settingsexportcsv.h"
#include <QFile>
...
SettingsExportCSV::SettingsExportCSV(quirkyturtcoinGUI* _window, QWidget *parent) :
...
void SettingsExportCSV::selectFileOutput(const bool& isTxExport)
{
    QString filename = GUIUtil::getSaveFileName(this,
                                        ...
                                        isTxExport ? tr("quirkyturtcoin_tx_csv_export(*.csv)") : tr("quirkyturtcoin_addresses_csv_export(*.csv)"),
                                        nullptr);
