...
#include "qt/quirkyturtcoin/forms/ui_topbar.h"
#include "qt/quirkyturtcoin/lockunlock.h"
#include "qt/quirkyturtcoin/qtutils.h"
#include "qt/quirkyturtcoin/receivedialog.h"
#include "qt/quirkyturtcoin/loadingdialog.h"
#include "askpassphrasedialog.h"

#include "bitcoinunits.h"
#include "qt/quirkyturtcoin/balancebubble.h"
...
TopBar::TopBar(quirkyturtcoinGUI* _mainWindow, QWidget *parent) :
...
void TopBar::loadWalletModel()
{
    ...
    // update the display unit, to not use the default ("quirkyturtcoin")
    updateDisplayUnit();
