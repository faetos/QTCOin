...
#include <QWidget>
#include <QString>
#include "qt/quirkyturtcoin/prunnable.h"
...
class PWidget : public QWidget, public Runnable, public Translator
{
    Q_OBJECT
public:
    explicit PWidget(quirkyturtcoinGUI* _window = nullptr, QWidget *parent = nullptr);
    explicit PWidget(PWidget *parent = nullptr);

    void setClientModel(ClientModel* model);
    void setWalletModel(WalletModel* model);

    quirkyturtcoinGUI* getWindow() { return this->window; }
