...
#ifndef quirkyturtcoin_QT_WALLETMODEL_H
#define quirkyturtcoin_QT_WALLETMODEL_H
...
/** Interface to quirkyturtcoin wallet from Qt view code. */
...
#endif // quirkyturtcoin_QT_WALLETMODEL_H
