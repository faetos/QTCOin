...
void AskPassphraseDialog::accept()
{
    ...
    case Mode::Encrypt: {
        ...
        if (ret) {
            ...
            quirkyturtcoinGUI* window = static_cast<quirkyturtcoinGUI*>(parentWidget());
...
{
    quirkyturtcoinGUI* gui = static_cast<quirkyturtcoinGUI*>(parentWidget());
...
{
    hide();
    static_cast<quirkyturtcoinGUI*>(parentWidget())->showHide(true);
    openStandardDialog(
            tr("Wallet encrypted"),
            "<qt>" +
            tr("quirkyturtcoin will close now to finish the encryption process. "
