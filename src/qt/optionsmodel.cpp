...
void OptionsModel::setDisplayDefaultOptions(QSettings& settings, bool reset)
{
    ...
    if (settings.contains("nAnonymizequirkyturtcoinAmount") || reset)
        gArgs.SoftSetArg("-anonymizequirkyturtcoinamount", settings.value("nAnonymizequirkyturtcoinAmount").toString().toStdString());
...
void OptionsModel::Reset()
{
    ...
    settings.clear();
    resetSettings = true; // Needed in quirkyturtcoin.cpp during shotdown to also remove the window positions
