...
/** Utility functions used by the quirkyturtcoin Qt UI.
 */
namespace GUIUtil
{
...
// Render quirkyturtcoin addresses in monospace font
...
// Parse "quirkyturtcoin:" URI into recipient object, return true on successful parsing
