...
#define BOOST_TEST_MODULE quirkyturtcoin Test Suite
...
{
        ClearDatadirCache();
        pathTemp = fs::temp_directory_path() / strprintf("test_quirkyturtcoin_%lu_%i", (unsigned long)GetTime(), (int)(InsecureRandRange(100000)));
