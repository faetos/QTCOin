...
// Copyright (c) 2016-2020 The quirkyturtcoin developers
...
public:
    ...
    /**
     * Amount of quirkyturtcoin coming in to a transaction
...
// quirkyturtcoin: When check is false, this assumes that overwrites are never possible due to BIP34 always in effect
