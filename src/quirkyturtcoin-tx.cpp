...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help")) {
        ...
        std::string strUsage = _("quirkyturtcoin Core quirkyturtcoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  quirkyturtcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded quirkyturtcoin transaction") + "\n" +
                               "  quirkyturtcoin-tx [options] -create [commands]   " + _("Create hex-encoded quirkyturtcoin transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded quirkyturtcoin transaction
