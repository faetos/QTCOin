...
from test_framework.test_framework import quirkyturtcoinTier2TestFramework
...
class MasternodeGovernanceBasicTest(quirkyturtcoinTier2TestFramework):
    ...
    def run_test(self):
        ...
        firstProposalLink = "https://forum.quirkyturtcoin.org/t/test-proposal"
