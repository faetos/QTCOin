...
from test_framework.quirkyturtcoin_node import quirkyturtcoinTestNode
...
class quirkyturtcoin_ColdStakingTest(quirkyturtcoinTestFramework):
    ...
    def init_test(self):
        ...
        for i in range(self.num_nodes):
            self.test_nodes.append(quirkyturtcoinTestNode())
...
if __name__ == '__main__':
    quirkyturtcoin_ColdStakingTest().main()
