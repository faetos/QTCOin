...
class BudgetProposalTest(quirkyturtcoinTestFramework):
    ...
    def run_test(self):
        ...
        self.log.info("Test with invalid quirkyturtcoin address")
        assert_raises_rpc_error(-5, "Invalid quirkyturtcoin address", self.nodes[0].preparebudget,
