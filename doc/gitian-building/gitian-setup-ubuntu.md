...
The build script we'll be using is contained in the quirkyturtcoin github repository ([contrib/gitian-build.py](https://github.com/quirkyturtcoin-project/quirkyturtcoin/blob/master/contrib/gitian-build.py)). Since this is a completely fresh environment, we haven't yet cloned the quirkyturtcoin repository and will need to fetch this script with the following commands:

```bash
curl -L -O https://raw.githubusercontent.com/quirkyturtcoin-Project/quirkyturtcoin/master/contrib/gitian-build.py
...
- Clone the gitian-builder, gitian.sigs, quirkyturtcoin-detached-sigs, and quirkyturtcoin GitHub repos.
